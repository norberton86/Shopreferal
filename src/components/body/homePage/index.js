        ...
        return  <React.Fragment>
                    ...
                    <div className="two-area-container">
                        <div className="left">
                            ...
                            <ButtonAutoZone handler={this.goStepOne.bind(this)} text={'Join Shop Referral'} width={'283px'} height={'38px'} borderColor={'#f37f00'} backgroundColor={'#f37f00'} color='#ffffff'/>
